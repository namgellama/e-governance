...
function Navbar({ change, handleChange }) {
	...
	return (
		<nav className="w-full sticky top-0 bg-blue-700 text-white text-lg font-normal z-10 flex items-center justify-between py-3 px-2 md:px-8 md:flex-row md:py-1 lg:flex-row lg:py-0">
			...
			<div
				onClick={handleClick}
				className="absolute right-4 top-5 cursor-pointer lg:hidden hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
			>
				{!open ? (
			...
			<ul
				className={`w-full flex flex-col items-start bg-blue-700 absolute top-12 left-0 mt-3 pl-0 md:pl-5 lg:static lg:flex lg:flex-row lg:justify-end lg:mt-0 lg:py-2 opacity-100  ${
